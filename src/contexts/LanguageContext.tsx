...
const translations = {
  en: {
    ...
    "dashboard.gettingStartedDesc": "Complete these steps to make the most of Givlyn",
  ...
  es: {
    ...
    "dashboard.gettingStartedDesc": "Completa estos pasos para aprovechar al máximo Givlyn",
    ...
    "next": "Siguiente",
    "skip": "Saltar",
    "tourWelcome": "¡Bienvenido a Givlyn! 🎁",
