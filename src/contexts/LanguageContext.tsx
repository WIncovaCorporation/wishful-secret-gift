...
const translations = {
  en: {
    ...
    "howItWorks.comparisonGiftApp": "With GiftApp",
  ...
  es: {
    ...
    "howItWorks.comparisonGiftApp": "Con GiftApp",
    ...
    "howItWorks.faq2Q": "¿Por qué recomiendan ciertos productos?",
    "howItWorks.faq2A": "Nuestra IA analiza objetivamente reseñas, precios y características. Recomendamos lo genuinamente mejor, no lo que paga más comisión.",
    "howItWorks.faq3Q": "¿Puedo confiar en sus recomendaciones?",
    "howItWorks.faq3A": "Solo ganamos si estás satisfecho. Malas recomendaciones = no vuelves = no ganamos. Nuestro éxito depende de tu confianza.",
    "howItWorks.faq4Q": "¿Qué pasa si lo encuentro más barato en otro lugar?",
    "howItWorks.faq4A": "¡Perfecto! Te lo mostraremos. Nuestro objetivo es ayudarte a ahorrar, no atraparte. Si hay mejor oferta, nuestra IA la encontrará.",
