...
export const WelcomeOnboarding = () => {
  ...
  const handleSelectTemplate = async (templateType: string) => {
    ...
    const templates: Record<string, TemplateData> = {
      navidad: {
        name: `Secret Santa ${currentYear}`,
        description: "Intercambio navideño con amigos y familia",
        min_budget: "30",
        max_budget: "70",
      ...
      cumpleaños: {
        name: "Cumpleaños",
        description: "Intercambio de regalos para cumpleaños",
        min_budget: "20",
        max_budget: "50",
        exchange_date: "",
        notification_mode: "group",
      ...
      oficina: {
        name: "Intercambio de oficina",
        description: "Regalo corporativo entre compañeros",
        min_budget: "15",
        max_budget: "40",
        exchange_date: "",
        notification_mode: "group",
